...
export class WinnerStateRepository {
    ...
    `;
        try {
            ...
            throw new Error(`Failed to create winner: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
     ...
     */
    async updateStatus(giveawayId, userId, newStatus) {
      ...
      `;
            ...
            await client.query('ROLLBACK');
            throw new Error(`Failed to update winner status: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
        finally {
            client.release();
        }
     ...
     */
    async getWinner(giveawayId, userId) {
        const query = `
    ...
    `;
        try {
            ...
            throw new Error(`Failed to get winners: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
    ...
    `;
        try {
            ...
            throw new Error(`Failed to get pending winners: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
     ...
     */
    async hasWinnerState(giveawayId, userId) {
        const query = `
    ...
    `;
        try {
            ...
            throw new Error(`Failed to check winner state: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
     ...
     */
    async getPendingWinnersByUser(guildId, userId) {
        const query = `
    ...
    `;
        try {
            ...
            throw new Error(`Failed to get pending winners by user: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
...
//# sourceMappingURL=WinnerStateRepository.js.map