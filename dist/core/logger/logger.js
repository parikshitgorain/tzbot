...
(function (LogEventType) {
    LogEventType["MODERATION_ACTION"] = "moderation_action";
    LogEventType["VIOLATION_DETECTED"] = "violation_detected";
    LogEventType["MESSAGE_DELETED"] = "message_deleted";
    LogEventType["MALICIOUS_LINK"] = "malicious_link";
    LogEventType["SYSTEM_TRANSITION"] = "system_transition";
    LogEventType["ERROR"] = "error";
    LogEventType["SECURITY_EVENT"] = "security_event";
    LogEventType["PERFORMANCE_WARNING"] = "performance_warning";
    LogEventType["API_REQUEST"] = "api_request";
    LogEventType["DATABASE_OPERATION"] = "database_operation";
...
const consoleFormat = winston.format.combine(winston.format.colorize(), winston.format.timestamp({ format: 'YYYY-MM-DD HH:mm:ss' }), winston.format.printf(({ timestamp, level, message, eventType, ...meta }) => {
 ...
 */
export const logModeration = (context) => {
 ...
 */
export const logMessageDeletion = (context) => {
 ...
 */
export const logMaliciousLink = (context) => {
 ...
 */
export const logSystemTransition = (context) => {
 ...
 * @param context - Additional context
 */
export const logViolation = (userId, violationType, details, context) => {
 ...
 */
export const logPerformanceWarning = (message, context) => {
    logger.warn(message, {
 ...
 */
export const logDatabaseOperation = (operation, context) => {
