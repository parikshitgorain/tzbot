 ...
 */
export function verifyBotPermissions(guild) {
 ...
 */
export function formatPermissionsError(result, guild) {
 ...
 */
export function generateInviteUrl(clientId) {
 ...
 */
export function verifyPermissionsOnStartup(guild) {
