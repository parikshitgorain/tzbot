...
export class LinkScanner {
    ...
    constructor(customBlocklist, enableGoogleSafeBrowsing = true) {
     ...
     */
    async scanMessage(messageContent, userId, isModerator = false) {
     ...
     * @returns LinkScanResult
     */
    async checkGoogleSafeBrowsingApi(normalizedUrl, userId) {
        try {
