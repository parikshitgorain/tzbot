...
export class PunishmentCalculator {
    static RESET_PERIOD_DAYS = 30;
    static BAN_THRESHOLD_HOURS = 24;
    /**
     ...
     */
    calculatePunishment(offenseCount, previousTimeout) {
     ...
     */
    shouldResetOffenses(lastOffenseTimestamp) {
        const now = new Date();
     ...
     */
    getNextPunishmentDescription(currentOffenseCount) {
...
//# sourceMappingURL=punishment-calculator.js.map