...
/**
 * Timer references for a specific winner
 */
interface TimerRefs {
...
export class TimerManager {
   ...
   */
  private getTimerKey(giveawayId: string, userId: string): string {
   ...
   */
  private async handleReminderCallback(giveawayId: string, userId: string): Promise<void> {
    try {
   ...
   * Wraps the callback to handle errors and cleanup
   */
  private async handleExpiryCallback(giveawayId: string, userId: string): Promise<void> {
    try {
