...
class TZBotApplication {
  ...
  private aiManager!: import('@/ai/ai-manager.js').AIManager; // AI auto-reply manager
 ...
 */
async function sendCriticalErrorWebhook(errorType: string, error: Error): Promise<void> {
  try {
