 ...
 */
export const aiStatusCommand: CommandDefinition = {
  name: 'ai-status',
 ...
 */
export const aiClearHistoryCommand: CommandDefinition = {
 ...
 */
export const aiToggleCommand: CommandDefinition = {
  name: 'ai-toggle',
  ...
  async handler(interaction: ChatInputCommandInteraction): Promise<void> {
    ...
    try {
      ...
      const mutableConfig = config as { aiEnabled: boolean };
 ...
 */
export function createAICommands(): CommandDefinition[] {
